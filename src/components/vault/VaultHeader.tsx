...
export const VaultHeader: React.FC = () => {
  return (
    <div className="w-full font-normal max-md:max-w-full">
      <div className="flex w-full flex-col items-stretch text-[48px] text-white leading-none justify-center max-md:max-w-full max-md:text-[32px]">
        <div className="flex items-center gap-3">
          <img
            ...
            className="aspect-[1] object-contain w-9 rounded-[18px]"
            alt="Capital logo"
          />
          <h1 className="font-medium">
            Capital <span className="text-[rgba(121,121,121,1)]">Usual USDC</span>
          </h1>
        </div>
      </div>
      <div className="text-[rgba(206,206,206,1)] text-sm leading-5 mt-3 max-md:max-w-full">
        The Capital Usual USDC provides a set of liquid collateral markets
        ...
        <StatCard
          ...
          value={
            <>
              ...
              <span className="font-medium text-[rgba(121,121,121,1)]">M</span>
            </>
          }
          ...
          className="bg-[rgba(15,15,16,1)] border-[rgba(45,45,45,1)]"
        />
        <StatCard
