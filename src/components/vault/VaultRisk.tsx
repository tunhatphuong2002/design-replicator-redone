    ...
    <div className="w-full mt-6 max-md:max-w-full">
      <div className="flex w-full items-center gap-[18px] flex-wrap max-md:max-w-full">
        <StatCard
          ...
          value={
            <>
              <span className="text-[rgba(121,121,121,1)]">
                Not provided by
              </span>{" "}
              Curator
            </>
        ...
        />
        <StatCard title="Curator TVL" value="$244.45M" background="https://cdn.builder.io/api/v1/image/assets/a49eb3d9dab54612b6a60c9b4c26d13d/2fb9c5547b41dc0a22179981179f3f42c9d6af8f?placeholderIfAbsent=true" />
        <StatCard
